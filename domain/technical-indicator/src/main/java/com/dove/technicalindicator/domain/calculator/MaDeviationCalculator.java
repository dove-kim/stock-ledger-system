...
public class MaDeviationCalculator implements TechnicalIndicatorCalculator {
    ...
    public IndicatorType cursorType() {
        return IndicatorType.MA_DEVIATION_20;
    }
    ...
    public Map<IndicatorType, Double> calculate(List<DailyStockPrice> dailyStockPriceList) {
        ...
        return Map.of(
                IndicatorType.MA_DEVIATION_20, close / sma20 - 1.0,
                IndicatorType.MA_DEVIATION_60, close / sma60 - 1.0
        );
    }
