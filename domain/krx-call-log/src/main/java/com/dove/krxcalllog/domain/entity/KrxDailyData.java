package com.dove.krxcalllog.domain.entity;
...
public class KrxDailyData {
    ...
    public static KrxDailyData unsupportedMarket(LocalDate baseDate, MarketType marketType, LocalDateTime apiCallAt) {
        return KrxDailyData.builder()
                .baseDate(baseDate)
                .marketType(marketType)
