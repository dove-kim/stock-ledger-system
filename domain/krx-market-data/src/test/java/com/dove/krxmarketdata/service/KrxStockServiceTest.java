...
class KrxStockServiceTest {
    ...
    void getStockListBy_kospi_success() {
        ...
        // When
        List<KrxStockInfo> result = krxStockService.getStockListBy(MarketType.KOSPI, testDate);
        ...
        assertThat(stockInfo.marketType()).isEqualTo(MarketType.KOSPI);
        assertThat(stockInfo.closingPrice()).isEqualTo(8910L);
        ...
        assertThat(savedLog.getMarketType()).isEqualTo(MarketType.KOSPI);
    }
    ...
    void getStockListBy_kosdaq_success() {
        ...
        // When
        List<KrxStockInfo> result = krxStockService.getStockListBy(MarketType.KOSDAQ, testDate);
        ...
        assertThat(stockInfo.marketType()).isEqualTo(MarketType.KOSDAQ);
        assertThat(stockInfo.closingPrice()).isEqualTo(1030L);
        ...
        assertThat(savedLog.getRawData()).isEqualTo(mockResponse.toJson());
        assertThat(savedLog.getBaseDate()).isEqualTo(testDate);
        assertThat(savedLog.getMarketType()).isEqualTo(MarketType.KOSDAQ);
    }
    ...
    void getStockListBy_unsupportedMarketType() {
        // Given
        MarketType unsupportedType = MarketType.KONEX;
        ...
        assertThat(savedLog.getRawData()).isNull();
        assertThat(savedLog.getMarketType()).isEqualTo(unsupportedType);
    }
