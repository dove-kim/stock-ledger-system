...
@DisplayName("KrxStockResponse 테스트")
class KrxStockResponseTest {

    @Nested
    @DisplayName("Data 타입 변환")
    class DataTypeConversion {

        private final KrxStockResponse.Data data = new KrxStockResponse.Data(
    ...
    class ToJson {
        ...
        void shouldReturnEmptyArrayWhenNull() {
            KrxStockResponse response = new KrxStockResponse(null);
        ...
        void shouldConvertDataToJson() {
            ...
            KrxStockResponse response = new KrxStockResponse(List.of(data));
        ...
        void shouldJoinMultipleDataWithComma() {
            KrxStockResponse.Data data1 = new KrxStockResponse.Data(
                    "20240115", "005930", "삼성전자", "KOSPI", "",
                    "71000", "1000", "1.43", "70000", "72000", "69000",
                    "1500000", "0", "0", "0"
            );
            KrxStockResponse.Data data2 = new KrxStockResponse.Data(
                    "20240115", "000660", "SK하이닉스", "KOSPI", "",
                    "130000", "2000", "1.56", "128000", "131000", "127000",
                    "500000", "0", "0", "0"
            );
            KrxStockResponse response = new KrxStockResponse(List.of(data1, data2));
